...
my_update_settings CP_USER $COUCHPOTATO_USER $COUCHPOTATO_CONFIG_FILE
my_update_settings CP_HOME $COUCHPOTATO_INSTALL $COUCHPOTATO_CONFIG_FILE
my_update_settings CP_DATA $COUCHPOTATO_DATA $COUCHPOTATO_CONFIG_FILE
